...
const cacheName = 'CampbellFixitLevelup2-2020-09-20 23:26:59.028068'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'CampbellFixitLevelup2'.length) === 'CampbellFixitLevelup2') {
